...
<html>
  ...
  <body>
    <!--  header -->
    <div id="step-header">
      <div id="step-header-intro" class="step-header-content-block">
        <p class="no-margin">
          ...
          coast in 2009 and 2010, of rivers and streams in 2011, and from other studies. Data from 2007-2014 
          are shown by default.
        </p>
        <p><a href="#">Map Instructions</a></p>
      </div>
      ...
      <div id="step-header-attributions" class="step-header-content-block">
        <p class="title no-margin" style="margin-bottom:15px;">This map shows data generated by:</p>
